...
import at.jku.dke.harmonic.privacyEngine.dto.FitnessQuantilesDTO;
...
public class PrivacyEngineService {
	 ...
	 */
	public PopulationOrderDTO computePopulationOrder(JeneticsOptimization optimization, Integer[][] input) {
