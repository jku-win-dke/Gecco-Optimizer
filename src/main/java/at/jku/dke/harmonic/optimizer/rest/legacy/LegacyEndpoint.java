package at.jku.dke.harmonic.optimizer.rest.legacy;

import at.jku.dke.harmonic.optimizer.service.OptimizationService;
import at.jku.dke.harmonic.optimizer.service.dto.FitnessMethodEnum;
import at.jku.dke.harmonic.optimizer.service.dto.FlightDTO;
import at.jku.dke.harmonic.optimizer.service.dto.MarginsDTO;
import at.jku.dke.harmonic.optimizer.service.dto.OptimizationModeEnum;
...
public class LegacyEndpoint {
    ...
    @ApiOperation(
            ...
            response = at.jku.dke.harmonic.optimizer.service.dto.OptimizationDTO.class,
    ...
    public ResponseEntity<at.jku.dke.harmonic.optimizer.service.dto.OptimizationDTO> convertOptimization(@RequestBody OptimizationDTO input) {
        ResponseEntity<at.jku.dke.harmonic.optimizer.service.dto.OptimizationDTO> optimizationResponse;

        try {
            at.jku.dke.harmonic.optimizer.service.dto.OptimizationDTO optimizationDto =
                    new at.jku.dke.harmonic.optimizer.service.dto.OptimizationDTO();
            ...
            at.jku.dke.harmonic.optimizer.service.dto.FlightDTO[] flights = Arrays.stream(input.getFlights())
                    .map(flight -> {
                        ...
                        Optional<at.jku.dke.harmonic.optimizer.rest.legacy.MarginsDTO> oldMargins = null;
                    ...
                    .toArray(at.jku.dke.harmonic.optimizer.service.dto.FlightDTO[]::new);

            optimizationDto.setFlights(flights);

            logger.info("Done. Converting slots ...");

            at.jku.dke.harmonic.optimizer.service.dto.SlotDTO[] slots = Arrays.stream(input.getSlots())
                    .map(slot -> {
                        at.jku.dke.harmonic.optimizer.service.dto.SlotDTO newSlot =
                                new at.jku.dke.harmonic.optimizer.service.dto.SlotDTO();

                        newSlot.setTime(LocalDateTime.ofInstant(slot.getTime(), ZoneOffset.UTC));

                        return newSlot;
                    })
                    .toArray(at.jku.dke.harmonic.optimizer.service.dto.SlotDTO[]::new);
    ...
    public ResponseEntity<at.jku.dke.harmonic.optimizer.service.dto.OptimizationDTO> createAndInitializeOptimizationLegacy(
        ...
        ResponseEntity<at.jku.dke.harmonic.optimizer.service.dto.OptimizationDTO> optimizationResponse = null;

    	at.jku.dke.harmonic.optimizer.service.dto.OptimizationDTO optDto = null;
    	
    	ResponseEntity<at.jku.dke.harmonic.optimizer.service.dto.OptimizationDTO> optimizationConvertResponse =
